...
|---------|------------|-----------|
| E-Commerce | HTML/CSS/JS/MySQL | [Demo](link) |
| Portfolio | Figma/HTML/CSS/JS | [You're here!](.) |

![Hero Banner](https://via.placeholder.com/1200x400/667eea/ffffff?text=Full+Stack+Developer)
